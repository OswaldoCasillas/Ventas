...
def build_reports(
    ...
    for col in [
        ...
        "issue", "metodo_pago", "payment", "descripcion", "product_id", "source_id",
    ]:
    ...
    _write_csv(sales_export, ventas_detalle_csv)
    ...
    if not prod_detail.empty:
        ...
        _write_csv(prod_export, prod_csv)
